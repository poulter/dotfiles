...
hi Comment    term=NONE      cterm=NONE ctermfg=darkblue     gui=NONE guifg=red2
hi Constant   term=bold      cterm=bold ctermfg=green      gui=NONE guifg=green3
hi Special    term=bold      cterm=NONE ctermfg=darkred     gui=NONE guifg=deeppink
hi Statement  term=bold      cterm=bold ctermfg=darkblue     gui=bold guifg=blue
