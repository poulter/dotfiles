...
hi SpecialKey term=bold ctermfg=White guifg=White
...
hi NonText term=none ctermfg=brown ctermbg=none  gui=bold guifg=gray guibg=white
...
hi Type	      term=underline cterm=NONE ctermfg=white         gui=bold guifg=white 
